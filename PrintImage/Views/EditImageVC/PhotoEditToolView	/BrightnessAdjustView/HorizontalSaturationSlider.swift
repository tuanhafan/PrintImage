//
//  HorizontalSaturationSlider.swift
//  PrintImage
//
...
import UIKit
import CoreImage
class HorizontalSaturationSlider: UIControl {
    private let trackView = UIView()
    private let fillView = UIView()
    private let knobView = UIImageView()
    private let context = CIContext()
    var originalImage: UIImage?
    var onSaturationChanged: ((CGFloat) -> Void)?
    ...
    private func setup() {
        ...
        // hiển thị icon
        knobView.image = UIImage(systemName: "paintbrush.fill")?.withTintColor(.black, renderingMode: .alwaysOriginal)
    ...
    override func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
      ...
      private func updateValue(with touch: UITouch) {
            ...
            onSaturationChanged?(value) // gửi value
        }
